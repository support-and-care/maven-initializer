...
class ProjectGeneratorITTest {
  ...
  void testGeneratedProjectWithAssertJBuildsSuccessfully()
    ...
    ProjectRequestDTO request = createValidRequest();
    request.setIncludeMavenWrapper(true);
    request.setAssertionLibrary("assertj");
    ...
    assertEquals(
        0, exitCode, "Maven build with AssertJ should succeed with exit code 0. Output: " + output);
  }
  ...
  void testGeneratedProjectWithHamcrestBuildsSuccessfully()
    ...
    ProjectRequestDTO request = createValidRequest();
    request.setIncludeMavenWrapper(true);
    request.setAssertionLibrary("hamcrest");
    ...
    assertEquals(
        0,
        exitCode,
        "Maven build with Hamcrest should succeed with exit code 0. Output: " + output);
  }
  ...
  void testGeneratedProjectWithNoAssertionLibraryBuildsSuccessfully()
    ...
    assertEquals(
        0,
        exitCode,
        "Maven build with JUnit only should succeed with exit code 0. Output: " + output);
  }
