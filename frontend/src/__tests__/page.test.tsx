...
describe("Home Page", () => {
  ...
  it("renders the project configuration form", () => {
    ...
    expect(screen.getByText("Configure your Maven project settings")).toBeInTheDocument();
  });

  it("renders the hero section", () => {
    render(<Home />);
    expect(screen.getByText("Build Better Java Projects")).toBeInTheDocument();
    expect(screen.getByText("Create production-ready Maven projects with the perfect dependencies, configuration, and structure. No more manual setup.")).toBeInTheDocument();
  });
  ...
  it("renders form fields", () => {
    ...
    expect(screen.getByPlaceholderText("My Awesome Project")).toBeInTheDocument();
    expect(screen.getByPlaceholderText("Describe your project's purpose and functionality...")).toBeInTheDocument();
  });
});
