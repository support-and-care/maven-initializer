...
const PLAUSIBLE_SCRIPT_SRC =
  "https://plausible.io/js/pa-K0UUqC6yi772K1zvtZGNw.js";
...
export const metadata: Metadata = {
  metadataBase: new URL("https://maven-starter.io"),
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <PlausibleProvider src={PLAUSIBLE_SCRIPT_SRC}>{app}</PlausibleProvider>
      </body>
    </html>
  );
}
